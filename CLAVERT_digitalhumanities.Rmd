...
The answer to those question depends on *how* Digital Humanities can be defined. And this *how* is far from easy. Based on a database made of *Day of DH* quotes, Jason Heppler created the website *What is Digital Humanities* that relies on 817 different definitions of DH.
